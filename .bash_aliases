...
alias nuvmake="d make -j $(nuvproc -m 1.6) -C ~/bms-device/fw"
alias nuvlint3="d pylint3 -j $(nuvproc -m 0.5) --rcfile=~/bms-device/config/pylintrc"
alias nuvlint2="d pylint -j $(nuvproc -m 0.5) --rcfile=~/bms-device/config/pylintrc"
alias nuvtestbms="d ~/bms-device/fw/bin/x86/bms_test.exe -c"
alias nuvtestsc="d ~/bms-device/fw/bin/x86/sc_test.exe -c"
alias nuvtestpi="d ~/bms-device/fw/bin/x86/pi_test.exe -c"
